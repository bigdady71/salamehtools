...
// Suppress any errors from showing as HTML
    ...
    $response = [
        ...
        'history' => array_map(function($action) {
            return [
                ...
                'role' => $action['performed_by_role'] ?? 'system',
        ...
        'movements' => array_map(function($move) {
            return [
                ...
                'warehouse_before' => (float)($move['warehouse_stock_before'] ?? 0),
                'warehouse_after' => (float)($move['warehouse_stock_after'] ?? 0),
                'sales_rep_before' => (float)($move['sales_rep_stock_before'] ?? 0),
                'sales_rep_after' => (float)($move['sales_rep_stock_after'] ?? 0),
